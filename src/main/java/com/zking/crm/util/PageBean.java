...
public class PageBean implements Serializable {
	...
	public void setPaginate(String paginate) {
		...
		if ("true".equalsIgnoreCase(paginate)) {
			this.paginate = true;
		} else {
			this.paginate = false;
		}
	...
	public int getMaxPageNumber() {
		...
		maxPageNumber = totalRecord % pageRecord == 0 ? maxPageNumber
				: maxPageNumber + 1;
	...
	public int getNextPageNumber() {
		...
		nextPageNumber = nextPageNumber > this.getMaxPageNumber() ? this
				.getMaxPageNumber() : nextPageNumber;
	...
	public String toString() {
		return "PageBean [curPage=" + curPage + ", pageRecord=" + pageRecord
